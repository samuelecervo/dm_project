-- multi-fact join, aggregazioni multiple, slice & dice 
-- su più dimensioni, misura derivata totale di vaccinazioni.
...
SELECT
    ...
    AVG(c.deceased) AS avg_deceased,
...
JOIN dw_layer.fact_vaccination v 
    ON c.region_key = v.region_code AND c.date_key = v.date_key
